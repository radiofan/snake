...
void Game::display_level_choice(){
    ...
    std::cout << "ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿" << std::endl
              << "³                                                                             ³" << std::endl
              << "³                   <ÄÄÄÄÄÄÄ     CHOICE LEVEL     ÄÄÄÄÄÄÄ>                    ³" << std::endl
              << "³                                                                             ³" << std::endl
    ...
    std::cout << str << String(69 - str.length(), ' ') << " º ³" << std::endl
              << "³ º                                                                         º ³" << std::endl
              << "³ º NAME: ";
    str = lvl.get_level_option(1).substr(0, 65);
    std::cout << str << String(65 - str.length(), ' ') << " º ³" << std::endl
              << "³ º                                                                         º ³" << std::endl
              << "³ º AUTHOR: ";
    str = lvl.get_level_option(2).substr(0, 63);
    std::cout << str << String(63-str.length(), ' ') << " º ³" << std::endl;
    if(lvl.error.erorrs.size()){
        std::cout << "³ º                                                                         º ³" << std::endl
                  << "³ º NOTICE:                                                                 º ³" << std::endl;
        if(!lvl.error.success)
            std::cout << "³ º                                                                         º ³" << std::endl
                      << "³ º       > !!!VALIDATION FAILED!!!                                         º ³" << std::endl;
        for(uint32_t i=0; i<lvl.error.erorrs.size(); i++){
            ...
            if(str.length()>63){
                for(uint16_t i1=63; i1<str.length(); i1 += 63){
                    std::cout << " º ³" << std::endl << "³ º         " << str.substr(i1, 63);
                }
            }
            if(str.length()%63)
    ...
    std::cout << "³ º                                                                         º ³" << std::endl
              ...
              << "³                                                                             ³" << std::endl;
    if(lvl.error.success)
        std::cout << "³                         ÕÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¸                         ³" << std::endl
                  << "³                         ³          START          ³                         ³" << std::endl
                  << "³                         ÔÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¾                         ³" << std::endl
                  << "³                                                                             ³" << std::endl;
    ...
    std::cout << "³                         ÕÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¸                         ³" << std::endl
              ...
              << "ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ" << std::endl;
    if(lvl.error.success){
        std::cout << "ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»" << std::endl
                  << "º                                LEVEL PREVIEW                                º" << std::endl
                  << "ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼" << std::endl
                  << std::endl;
        lvl.level_draw();
    }
